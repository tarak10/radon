...
exports.getBooksById = async function (req, res) {
    ...
    try {
        ...
        let reviewsData = await reviewModel.find({ bookId: book._id, isDeleted: false }).select({ isDeleted: 0, __v: 0, createdAt: 0, updatedAt: 0 })
         
        // let bookData= {
        //     book,
        //     reviewsData
        // }
        return res.status(200).send({ status: true,message: "Books List", data:{ book,reviewsData} })
